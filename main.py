...
if __name__ == "__main__":
    ...
    # Get stock data for a dynamically entered ticker symbol
    ...
    # Get news sentiment for the same dynamically entered ticker symbol
    ...
    # Get advanced analytics for a dynamically entered ticker symbol
