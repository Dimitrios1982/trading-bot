...
# Load combined_data
combined_data = pd.read_csv(f'./data/{ticker}_combined_data.csv')  # Replace with the actual path

# Drop rows with missing values
combined_data = combined_data.dropna()

# Extract features (X) and target variable (y)
features = combined_data[['open', 'high', 'low', 'close', 'volume']]
target = combined_data['overall_sentiment_score']
